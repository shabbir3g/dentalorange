...
(function($) {
	...
	$(".home-blocks .hblock:nth-child(2) div").addClass('bg-theme-colored-darker3');
	$(".home-blocks .hblock:nth-child(3) div").addClass('bg-theme-colored-darker5');
	$(".home-blocks .hblock:nth-child(4) div").addClass('bg-theme-colored-darker9');
	
	$(".abouticons .abouticon:nth-child(3) a.icon").removeClass('bg-theme-colored');
	$(".abouticons .abouticon:nth-child(4) a.icon").removeClass('bg-theme-colored');
	
	$(".abouticons .abouticon:nth-child(3) a.icon").addClass('bg-theme-colored2cont');
	$(".abouticons .abouticon:nth-child(4) a.icon").addClass('bg-theme-colored2cont');
	
	
	$(".home-blocks .hblock:nth-child(1) div a.icon i").addClass('flaticon-medical-blood8');
	$(".home-blocks .hblock:nth-child(2) div a.icon i").addClass('flaticon-medical-medical45');
	$(".home-blocks .hblock:nth-child(3) div a.icon i").addClass('flaticon-medical-pill');
	$(".home-blocks .hblock:nth-child(4) div a.icon i").addClass('fa fa-phone');
	
	
	$(".abouticons .abouticon:nth-child(1) a.icon i").addClass('flaticon-medical-first32');
	$(".abouticons .abouticon:nth-child(2) a.icon i").addClass('flaticon-medical-brush18');
	$(".abouticons .abouticon:nth-child(3) a.icon i").addClass('flaticon-medical-microscope13');
	$(".abouticons .abouticon:nth-child(4) a.icon i").addClass('flaticon-medical-teeth2');
